...
%Analisando o código, consegue-se determinar o tempo de execução de cada ciclo e, consequentemente, do programa (sendo número de pessoas = N e número de partilhas = P):
%
%\begin{itemize}
%%\item primeiro for:%\item segundo for: %\item primeiro while:%\item terceiro for:%
